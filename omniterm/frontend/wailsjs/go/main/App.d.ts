...
export function AIChatStream(arg1:string,arg2:Array<ai.Message>,arg3:ai.ClientConfig):Promise<void>;

export function AIChatWithImage(arg1:string,arg2:string,arg3:string,arg4:string,arg5:ai.ClientConfig):Promise<void>;
...
export function DeviceDetected(arg1:string,arg2:device.DeviceInfo):Promise<void>;
...
export function GetDeviceInfo(arg1:string):Promise<device.DeviceInfo>;
...
export function ImportKnowledge(arg1:string,arg2:string,arg3:string):Promise<void>;
...
export function ListKnowledge():Promise<Array<ai.RAGDocument>>;
...
export function SaveSkill(arg1:string,arg2:string,arg3:string,arg4:string,arg5:string):Promise<void>;

export function SaveTerminalContent(arg1:string,arg2:string):Promise<void>;

export function SearchKnowledge(arg1:string):Promise<Array<ai.RAGDocument>>;

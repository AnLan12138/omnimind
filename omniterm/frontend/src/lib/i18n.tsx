...
export const t: TranslationMap = {
  ...
  sshTunnels: { en: 'SSH Tunnels', zh: 'SSH 隧道' },
  ...
  clearBuffer: { en: 'Clear Buffer', zh: '清除缓冲' },
  ...
  connectSSHTunnel: { en: 'Connect via SSH to create tunnels.', zh: '通过 SSH 连接后创建隧道。' },
  ...
  saveTerminal: { en: 'Save Terminal Content', zh: '保存终端内容' },
  find: { en: 'Find', zh: '查找' },
